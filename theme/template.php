...
<div class="super_container">
  <header class="header" style="width:100%;height: 300px; ">
    <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
      
      <!-- Logo -->
      <div class="logo"><a href="#"><img class="logo_1" src="<?php echo WEB_ROOT;?>images/landmarklogo.png" alt=""><img class="logo_2" src="<?php echo WEB_ROOT;?>images/" alt=""><img class="logo_3" src="<?php echo WEB_ROOT;?>i" alt=""></a></div>
...
<!--         <div class="search_button">
  ...
  <div class="logo_overlay">
    <div class="logo_overlay_content d-flex flex-column align-items-center justify-content-center">
      <div class="logo"><a href="#"><img src="<?php echo WEB_ROOT;?>images/landmark_logo.png" alt=""></a></div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col">
          <div class="footer_logo text-center">
            <a href="#"><img src="images/landmarklogo.png" alt=""></a>
          </div>
